      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <Card>
            <CardContent>
              <Typography variant="h6" gutterBottom>
                Performance Levels (SDG 4.1.1a Framework)
              </Typography>

              {testStats.sdg_mpl_percentage !== undefined ? (
                <>
                  <Box sx={{ mt: 2, mb: 3, p: 2, bgcolor: 'primary.light', borderRadius: 1 }}>
                    <Typography variant="body2" color="primary.contrastText" gutterBottom>
                      <strong>SDG 4.1.1a: % at or above Minimum Proficiency Level</strong>
                    </Typography>
                    <Typography variant="h3" color="primary.contrastText">
                      {testStats.sdg_mpl_percentage?.toFixed(1)}%
                    </Typography>
                  </Box>
                    ...
                    <Table size="small">
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell align="right">{testStats.perf_below_minimum || 0} students</TableCell>
                          <TableCell align="right">
                            <strong>
                              {testStats.n ? ((testStats.perf_below_minimum / testStats.n) * 100).toFixed(2) : 0}%
                            </strong>
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>
                            <strong>Minimum Proficiency (MPL)</strong>
                            <br />
                            <Typography variant="caption" color="text.secondary">
                              25-49%
                            </Typography>
                          </TableCell>
                          <TableCell align="right">{testStats.perf_minimum || 0} students</TableCell>
                          <TableCell align="right">
                            <strong>
                              {testStats.n ? ((testStats.perf_minimum / testStats.n) * 100).toFixed(2) : 0}%
                            </strong>
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>
                            <strong>Moderate Proficiency</strong>
                            <br />
                            <Typography variant="caption" color="text.secondary">
                              50-74%
                            </Typography>
                          </TableCell>
                          <TableCell align="right">{testStats.perf_moderate || 0} students</TableCell>
                          <TableCell align="right">
                            <strong>
                              {testStats.n ? ((testStats.perf_moderate / testStats.n) * 100).toFixed(2) : 0}%
                            </strong>
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>
                            <strong>High Proficiency</strong>
                            <br />
                            <Typography variant="caption" color="text.secondary">
                              75-89%
                            </Typography>
                          </TableCell>
                          <TableCell align="right">{testStats.perf_high || 0} students</TableCell>
                          <TableCell align="right">
                            <strong>
                              {testStats.n ? ((testStats.perf_high / testStats.n) * 100).toFixed(2) : 0}%
                            </strong>
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          ...
                          <TableCell align="right">{testStats.perf_advanced || 0} students</TableCell>
                          <TableCell align="right">
                            <strong>
                              {testStats.n ? ((testStats.perf_advanced / testStats.n) * 100).toFixed(2) : 0}%
                            </strong>
                          </TableCell>
                        </TableRow>
                      </TableBody>
                ...
                <Typography color="text.secondary" sx={{ mt: 2 }}>
                  Performance level data not available
                </Typography>
              )}
            </CardContent>
          </Card>
